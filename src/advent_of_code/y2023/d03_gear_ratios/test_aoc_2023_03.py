...
from advent_of_code.y2023.d03_gear_ratios.types import Engine
...
@pytest.fixture
def actual_input() -> Engine:
    puzzle_input: str = (PUZZLE_DIR / "input.txt").read_text().strip()
    return aoc.parse_input(puzzle_input)


# @pytest.mark.skip(reason="Not implemented")
def test_parse_example1(example1: Engine) -> None:
...
# @pytest.mark.skip(reason="Not implemented")
def test_part1_example1(example1: Engine) -> None:
    """Test part 1 on example input."""
    assert aoc.solve_part1(example1) == 4361


# @pytest.mark.skip(reason="Not implemented")
def test_part1_solution(actual_input: Engine) -> None:
    """Test part 1 on actual solution."""
    assert aoc.solve_part1(actual_input) == 525911


# @pytest.mark.skip(reason="Not implemented")
def test_part2_example1(example1: Engine) -> None:
    """Test part 2 on example input."""
    assert aoc.solve_part2(example1) == 467835


@pytest.mark.skip(reason="Not implemented")
def test_part2_example2(example2: Engine) -> None:
    """Test part 2 on example input."""
    assert aoc.solve_part2(example2) == ...


@pytest.mark.skip(reason="Not implemented")
def test_part2_solution(actual_input: Engine) -> None:
